...
with CorsSupport {
  ...
  get("/profile/:profileId/data/:datasource/:fromDate/:toDate") {
    ...
    try {
      ...
      val rawData = DatafindingsThirdLevelDataDAO.getThirdLevelDataDefault(fromDate, toDate, profileId, params("datasource"))
  ...
  post("/profile/:profileId/data/:datasource/:fromDate/:toDate/:keyortopic") {
    ...
    try {
      ...
      val lineData = params("keyortopic") match {
        case "keywords" => DatafindingsThirdLevelDataDAO.getThirdLevelDataByKeywords(fromDate, toDate, profileId, idsList, params("datasource"))
        case "topics" => DatafindingsThirdLevelDataDAO.getThirdLevelDataByTopics(fromDate, toDate, profileId, idsList, params("datasource"))
      }
