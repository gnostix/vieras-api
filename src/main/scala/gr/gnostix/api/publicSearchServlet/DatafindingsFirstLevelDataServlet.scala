...
// we consider "social" the following datasources {twitter, facebook, gplus, youtube}
  get("/profile/:profileId/data/stats/social/:datasource/:fromDate/:toDate") {
    ...
    try {
      ...
      val profileId = params("profileId").toInt
      val rawData = DatafindingsFirstLevelDataDAO.getFirstLevelDataDefault(fromDate, toDate, user.userId, profileId, params("datasource"))
  ...
  post("/profile/:profileId/data/stats/social/:datasource/:fromDate/:toDate/:keyortopic") {
    ...
    try {
      ...
      val rawData = params("keyortopic") match {
        case "keywords" => DatafindingsFirstLevelDataDAO.getFirstLevelDataByKeywords(fromDate, toDate, user.userId, profileId, idsList, params("datasource"))
        case "topics" => DatafindingsFirstLevelDataDAO.getFirstLevelDataByTopics(fromDate, toDate, user.userId, profileId, idsList, params("datasource"))
      }
  ...
  get("/profile/:profileId/data/stats/feed/:type/:fromDate/:toDate") {
    ...
    try {
      ...
      val lineData: SocialData = params("type") match {
        case "blogs" => DatafindingsFirstLevelDataDAO.getFirstLevelDataDefault(fromDate, toDate, user.userId, profileId, FeedDatasources.blogs.head._2)
        case "news" => DatafindingsFirstLevelDataDAO.getFirstLevelDataDefault(fromDate, toDate, user.userId, profileId, FeedDatasources.news.head._2)
        case "personal" => DatafindingsFirstLevelDataDAO.getFirstLevelDataDefault(fromDate, toDate, user.userId, profileId, FeedDatasources.personal.head._2)
      }
    ...
    try {
      ...
      val lineData: SocialData = params("type") match {
        case "blogs" => params("keyortopic") match {
          case "keywords" => DatafindingsFirstLevelDataDAO.getFirstLevelDataByKeywords(fromDate, toDate, user.userId, profileId, idsList, FeedDatasources.blogs.head._2)
          case "topics" => DatafindingsFirstLevelDataDAO.getFirstLevelDataByTopics(fromDate, toDate, user.userId, profileId, idsList, FeedDatasources.blogs.head._2)
        }
        case "news" => params("keyortopic") match {
          case "keywords" => DatafindingsFirstLevelDataDAO.getFirstLevelDataByKeywords(fromDate, toDate, user.userId, profileId, idsList, FeedDatasources.news.head._2)
          case "topics" => DatafindingsFirstLevelDataDAO.getFirstLevelDataByTopics(fromDate, toDate, user.userId, profileId, idsList, FeedDatasources.news.head._2)
        }
        case "personal" => params("keyortopic") match {
          case "keywords" => DatafindingsFirstLevelDataDAO.getFirstLevelDataByKeywords(fromDate, toDate, user.userId, profileId, idsList, FeedDatasources.personal.head._2)
          case "topics" => DatafindingsFirstLevelDataDAO.getFirstLevelDataByTopics(fromDate, toDate, user.userId, profileId, idsList, FeedDatasources.personal.head._2)
        }
      }
      DataResponse(200, "Coulio Bro!!!", lineData)
  ...
  post("/profile/:profileId/data/stats/web/:websource/:fromDate/:toDate") {
    ...
    try {
      ...
      val lineData: SocialData = params("websource") match {
        case "web" => DatafindingsFirstLevelDataDAO.getFirstLevelDataDefault(fromDate, toDate, user.userId, profileId, WebDatasources.web.head._2)
        case "linkedin" => DatafindingsFirstLevelDataDAO.getFirstLevelDataDefault(fromDate, toDate, user.userId, profileId, WebDatasources.linkedin.head._2)
      }
    ...
    try {
      ...
      val lineData: SocialData = params("websource") match {
        case "web" => params("keyortopic") match {
          case "keywords" => DatafindingsFirstLevelDataDAO.getFirstLevelDataByKeywords(fromDate, toDate, user.userId, profileId, idsList, WebDatasources.web.head._2)
          case "topics" => DatafindingsFirstLevelDataDAO.getFirstLevelDataByTopics(fromDate, toDate, user.userId, profileId, idsList, WebDatasources.linkedin.head._2)
        }
