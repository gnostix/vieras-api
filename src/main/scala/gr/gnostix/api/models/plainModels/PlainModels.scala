...
case class HotelTextData(reviewId: Int, text: String, rating: Double, dsId: Int, dsName: String, created: Timestamp, hotelUrl: String, countryCode: String, stayType: String)
case class HotelTextDataRating(reviewId: Int, text: String, rating: Double, dsId: Int, dsName: String, created: Timestamp, hotelUrl: String, countryCode: String, stayType: String,ratingName: String, ratingValue: Double)
case class HotelTextDataRatingFull(reviewId: Int, text: String, rating: Double, dsId: Int, dsName: String, created: Timestamp, hotelUrl: String, countryCode: String, stayType: String, servicesRating: Map[String, Int])
